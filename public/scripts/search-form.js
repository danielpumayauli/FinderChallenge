/*From @Daniel Pumayauli
Dev for Finder Challenge by  Test Frontend*/
...
document.addEventListener('DOMContentLoaded', function(){
    var searchKey = document.querySelector('input[type=text]');
        ...
        searchKey.addEventListener('keyup', function(event){
            clearResultsDiv();            if(searchKey.value.length === 0){
                ...
                $.ajax({url: "books-schema.json"}).done(function(schema){
    ...
    //Escuchador para agregar nuevos elementos li en el DOM
...
/**
 * Función para filtrar los títulos
 */
...
/**
 * Function para procesar el resultados de searchResults
 */
...
/**
 * Función para crear elementos al DOM
 */
...
/**
 * function para resetear resultados
 */
